...
and *Do not show window content when moving windows*
1. Minimize all active windows by pressing 
...
Expected results:
* decoration of the maximized window is changed in accordance to the state of *Undecorate maximized windows*.
...
To use Compiz we need to install it first with `sudo apt-get install compiz-mate`.
